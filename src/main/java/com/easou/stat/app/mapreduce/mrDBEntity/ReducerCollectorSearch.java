...
/**
 * 
 * @ClassName: ReducerCollectorSearch.java
 * @Description: 搜索基本统计
 * @author: Asa
 * @date: 2014年2月25日 下午2:27:38
 *
 */
public class ReducerCollectorSearch implements DBWritable, Writable {
	/** @Fields jobid : Job ID **/
	...
	public static String getTableNameByGranularity(Granularity granularity) {
		switch (granularity) {
		case HOUR:
			return "STAT_SEARCH_BASE_INFO_HOUR";
		default:
			return "STAT_SEARCH_BASE_INFO";
		}
	}
	...
	public ReducerCollectorSearch(String jobid, String statDate,
