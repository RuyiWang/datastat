...
public class ReducerCollectorUserRevisit  implements DBWritable, Writable {
	/** @Fields jobid : Job ID **/
	...
	public ReducerCollectorUserRevisit() {
		super();
		// TODO Auto-generated constructor stub
	}

	public static String getTableNameByGranularity() {
		return "STAT_USER_REVISIT_INFO";
	}
	...
	public ReducerCollectorUserRevisit(String jobid, String statDate,
