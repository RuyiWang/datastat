...
public class ReducerCollectorUseTime implements DBWritable, Writable {
	...
	public ReducerCollectorUseTime() {
		super();
	}
	
	
	public ReducerCollectorUseTime(String jobid, String statDate,
	...
	public static String getTableNameByGranularity(Granularity granularity) {
		switch (granularity) {
		case HOUR:
			return "STAT_USETIME_BASE_INFO_HOUR";
		case DAY:
			return "STAT_USETIME_BASE_INFO";
		case WEEK:
			return "STAT_USETIME_BASE_INFO";
		case MONTH:
			return "STAT_USETIME_BASE_INFO";
