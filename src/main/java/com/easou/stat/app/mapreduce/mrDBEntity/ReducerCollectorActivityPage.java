...
public class ReducerCollectorActivityPage implements DBWritable, Writable {
	/** @Fields jobid : Job ID **/
	...
	public ReducerCollectorActivityPage() {
		super();
		// TODO Auto-generated constructor stub
	}

	public static String getTableNameByGranularity() {
		return "STAT_ACTIVITY_PAGE_BASE_INFO";
	}
	...
	public ReducerCollectorActivityPage(String jobid, String statDate, String dimType,
	...
	public String toString() {
		return "ReducerCollectorEvent [appkey=" + appkey + ", dim_code="
				+ dim_code + ", dim_type=" + dim_type + ", indicator=" + indicator + ", jobid=" + jobid
