...
public class ReducerCollectorActivityUsers implements DBWritable, Writable {
	/** @Fields jobid : Job ID **/
	...
	public ReducerCollectorActivityUsers() {
		super();
	...
	public static String getTableNameByGranularity(Granularity granularity) {
		switch (granularity) {
		case HOUR:
			return "STAT_USER_BASE_INFO_HOUR";
		case DAY:
			return "STAT_USER_BASE_INFO";
		case WEEK:
			return "STAT_USER_BASE_INFO";
		case MONTH:
			return "STAT_USER_BASE_INFO";
		case AHOUR:
			return "STAT_USER_BASE_INFO_AHOUR";
		default:
			return "STAT_USER_BASE_INFO";
		}
	...
	public ReducerCollectorActivityUsers(String jobid, String statDate,
