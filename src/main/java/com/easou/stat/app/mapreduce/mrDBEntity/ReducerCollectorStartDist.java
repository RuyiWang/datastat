...
public class ReducerCollectorStartDist implements DBWritable, Writable {
	...
	public ReducerCollectorStartDist() {
		super();
	}
	
	
	public ReducerCollectorStartDist(String jobid, String statDate,
			String dimType, String appkey, String dimCode, String indicator,
			String phoneSoftversion, String timePeroid, Long value, String extend_dimcode) {
		super();
		this.jobid = jobid;
		stat_date = statDate;
		dim_type = dimType;
	...
	public static String getTableNameByGranularity(Granularity granularity) {
		switch (granularity) {
		case HOUR:
			return "STAT_STARTDIST_BASE_INFO";
		case DAY:
			return "STAT_STARTDIST_BASE_INFO";
		case WEEK:
			return "STAT_STARTDIST_BASE_INFO";
	...
	public static String[] getFields() {
		return new String[] { "APPKEY", "PHONE_SOFTVERSION",
				"TIME_PERIOD", "STAT_DATE", "DIM_TYPE", "DIM_CODE",
