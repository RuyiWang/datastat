...
public class ReducerCollectorActivityUsersAllDay implements DBWritable, Writable{
	...
	public ReducerCollectorActivityUsersAllDay() {
		super();
	...
	public ReducerCollectorActivityUsersAllDay(String jobid, String statDate,
