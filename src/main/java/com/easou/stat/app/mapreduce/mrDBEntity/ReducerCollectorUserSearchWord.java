...
public class ReducerCollectorUserSearchWord implements DBWritable, Writable {
	/** @Fields jobid : Job ID **/
	...
	public ReducerCollectorUserSearchWord() {
		super();
		// TODO Auto-generated constructor stub
	}

	public static String getTableNameByGranularity() {
		return "STAT_USER_SEARCHWORD_INFO";
	}
	...
	public ReducerCollectorUserSearchWord(String jobid, String statDate,
